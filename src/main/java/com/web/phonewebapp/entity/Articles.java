...
@NamedQueries({
    ...
    @NamedQuery(name = "Articles.findByPricePerUnit", query = "SELECT a FROM Articles a WHERE a.pricePerUnit = :pricePerUnit")})
public class Articles implements Serializable {
    ...
    public Articles(Integer id, String name, int amount, double pricePerUnit) {
        this.id = id;
        this.name = name;
        this.amount = amount;
    ...
    public String toString() {
        return "com.web.phonewebapp.entity.Articles[ id=" + id + " ]";
    }
